...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-48 overflow-hidden rounded-lg border border-line bg-surface p-1 text-fg shadow-panel",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label className={cn("px-2 py-1.5 text-2xs uppercase tracking-[0.14em] text-subtle", className)} {...props} />
));
